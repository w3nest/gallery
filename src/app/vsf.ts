...
// import type { NotebookTypes } from "mkdocs-ts";
...
//       content: module.html() as AnyVirtualDOM,
//       maxWidth: "50%",
//       maxHeight: "50%",
//     });
//   }
//   displayModuleJournal(_module: Immutable<Modules.ImplementationTrait>) {}
//   displayModuleDocumentation(_module: Immutable<Modules.ImplementationTrait>) {}
...
//               isElementInViewport(elem, "FlowChart 3D", isInViewPort$);
//             },
//             children: [
//               {
//                 source$: isInViewPort$,
...
//             class: {
//               source$: loading$,
//               vdomMap: (l) => (l ? "fa-spin fa-spinner" : "fa-sync fv-pointer"),
//               wrapper: (d) => `fas ${d}`,
//             },
//             onclick: () => {
//               loading$.next(true);
