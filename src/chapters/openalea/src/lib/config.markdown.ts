import { fromMarkdown, MdWidgets, IconFactory } from 'mkdocs-ts'
...
export const placeholders = {
    ...
    '{{tb-openalea}}':
        "'🌳': '@vs-flow/tb-openalea#^0.1.0-wip',  // modules for openalea",
}
...
IconFactory.register({
    openalea: {
        ...
        src: getUrlBase(setup.name, setup.version) + '/assets/openalea.png',
    },
})
